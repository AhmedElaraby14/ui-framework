...
public class Wait {
    ...
    public static void untilElementIsInVisible(WebDriver webDriver, WebElement webElement, Long timeOutInSeconds) {
        new WebDriverWait(webDriver, Duration.ofSeconds(timeOutInSeconds)).until(ExpectedConditions.invisibilityOf(webElement));
    }
    ...
    public static void untilTextContain(WebDriver webDriver, String text, Long timeOutInSeconds,WebElement webElement) {
        new WebDriverWait(webDriver, Duration.ofSeconds(timeOutInSeconds)).until(ExpectedConditions.textToBePresentInElement(webElement,text));
    }
